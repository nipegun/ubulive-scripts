    ...
    do
      case $choice in
        ...
        7)
          ...
          sudo wget https://raw.githubusercontent.com/nipegun/ubulive-scripts/main/Recursos/bootx64.efi -O /OpenWrt/PartOVMF/EFI/Boot/bootx64.efi
        ;;
        ...
        13)
          ...
          echo ""
          sudo mkdir -p                                                                                   /OpenWrt/PartOVMF/scripts/ 2> /dev/null
          sudo wget https://raw.githubusercontent.com/nipegun/o-scripts/master/PostInst/ConfigurarOpenWrt19ComoMVdeProxmox.sh -O /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh
