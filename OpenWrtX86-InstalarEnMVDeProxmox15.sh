    ...
    do
      case $choice in
        ...
        13)
          ...
          sudo su -c 'echo "echo "  option proto 'static'"               >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option gateway '192.168.0.1'"        >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option ipaddr '192.168.0.201'"       >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option netmask '255.255.255.0'"      >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list dns '1.1.1.1'"                  >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo ""                                      >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "config interface 'LAN'"                >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option type 'bridge'"                >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option ifname 'eth1 eth2 eth3 eth4'" >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option proto 'static'"               >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option ipaddr '192.168.1.1'"         >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option netmask '255.255.255.0'"      >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list dns '1.1.1.1'"                  >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option delegate '0'"                 >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option force_link '0'"               >> /etc/config/network"       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "# Permitir SSH desde WAN"                                                  >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "config rule"                    >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option name 'Allow-SSH-WAN'"  >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option target 'ACCEPT'"       >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list proto 'tcp'"             >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option dest_port '22'"        >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option src 'wan'"             >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "# Permitir LUCI desde WAN"                                                 >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "config rule"                    >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option name 'Allow-LUCI-WAN'" >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option target 'ACCEPT'"       >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list proto 'tcp'"             >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option dest_port '80'"        >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option src 'wan'"             >> /etc/config/firewall"             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "# Adblock"                                                                 >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "mkdir -p /root/logs/dns/"                                                  >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "config adblock 'global'"                      > /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_dnsfilereset '0'"               >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_backup '1'"                     >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_maxqueue '4'"                   >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_dns 'dnsmasq'"                  >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_fetchutil 'uclient-fetch'"      >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_report '1'"                     >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_mail '1'"                       >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_mailreceiver 'mail@gmail.com'"  >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_dnsflush '1'"                   >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_mailtopic 'AdBlock de OpenWrt'" >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_debug '1'"                      >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option adb_forcedns '1'"                   >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'adaway'"                 >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'adguard'"                >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'android_tracking'"       >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'anti_ad'"                >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'disconnect'"             >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'firetv_tracking'"        >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'malwaredomains'"         >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'malwarelist'"            >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'notracking'"             >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'openphish'"              >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'phishing_army'"          >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'spam404'"                >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'stopforumspam'"          >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_sources 'whocares'"               >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_safesearch '0'"                   >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_reportdir '/root/logs/dns'"       >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_repiface 'br-LAN'"                >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  list adb_enabled '1'"                      >> /etc/config/adblock" >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "# DHCP en LAN"                                                             >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "config dhcp 'LAN'"        >> /etc/config/dhcp"                       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option start '100'"     >> /etc/config/dhcp"                       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option leasetime '12h'" >> /etc/config/dhcp"                       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option interface 'LAN'" >> /etc/config/dhcp"                       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "echo "  option limit '199'"     >> /etc/config/dhcp"                       >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "rm -rf /root/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh"                  >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo ""                                                                          >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
          sudo su -c 'echo "poweroff"                                                                  >> /OpenWrt/PartOVMF/scripts/3-PrepararOpenWrtParaMVDeProxmox.sh'
