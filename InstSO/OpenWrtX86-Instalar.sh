    ...
    do
      case $choice in
        ...
        5)
          ...
          VersOpenWrt=$(curl -sL https://downloads.openwrt.org | grep eleases | grep 22 | head -n1 | cut -d'"' -f2 | cut -d'/' -f2)
	  ...
	  sudo su -c 'echo "  option proto '"'dhcp'"'"                                               >> /OpenWrt/PartEFI/scripts/network'
          ...
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config device"                                                           >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option name '"'br-lan'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option type '"'bridge'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          ...
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config interface '"'lan'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option device '"'br-lan'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option proto '"'static'"'"                                             >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option ipaddr '"'192.168.1.1'"'"                                       >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option netmask '"'255.255.255.0'"'"                                    >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option delegate '"'0'"'"                                               >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  list dns '"'192.168.1.1'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config device"                                                           >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option name '"'br-iot'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option type '"'bridge'"'"                                              >> /OpenWrt/PartEFI/scripts/network'  
          sudo su -c 'echo "  option bridge_empty '"'1'"'"                                           >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config interface '"'iot'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option proto '"'static'"'"                                             >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option ipaddr '"'192.168.2.1'"'"                                       >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option netmask '"'255.255.255.0'"'"                                    >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option device '"'br-iot'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option delegate '"'0'"'"                                               >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  list dns '"'192.168.2.1'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config device"                                                           >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option name '"'br-inv'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option type '"'bridge'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option bridge_empty '"'1'"'"                                           >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config interface '"'inv'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option proto '"'static'"'"                                             >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option ipaddr '"'192.168.3.1'"'"                                       >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option netmask '"'255.255.255.0'"'"                                    >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option device '"'br-inv'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option delegate '"'0'"'"                                               >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  list dns '"'192.168.3.1'"'"                                            >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo ""                                                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "config interface '"'vpn'"'"                                              >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option proto '"'wireguard'"'"                                          >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option private_key '"'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx='"'" >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option listen_port '"'51820'"'"                                        >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  list addresses '"'192.168.255.1/24'"'"                                 >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option force_link '"'1'"'"                                             >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  option delegate '"'0'"'"                                               >> /OpenWrt/PartEFI/scripts/network'
          sudo su -c 'echo "  list dns '"'192.168.255.1'"'"                                          >> /OpenWrt/PartEFI/scripts/network'
